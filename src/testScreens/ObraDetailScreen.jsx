...
const ObraDetailScreen = ({ route, navigation }) => {
    ...
    return (
        <View style={styles.container} >
            ...
            {/*Element Detail*/}
            <ScrollView contentInsetAdjustmentBehavior='automatic' showsVerticalScrollIndicator={false} style={styles.itemContainer} >

            <View style={styles.itemDetail}>
                <View style={styles.itemDetailInfo }>
                    <Text style={styles.itemDetailInfoText }>Nombre obra: {Nombre}</Text>
                    <Text style={styles.itemDetailInfoText }>Propietario obra: {Propietario}</Text>
                    <Text style={styles.itemDetailInfoText }>Direccion obra: {Direccion}</Text>
